...
from custom_graphgym.utils import negate_edge_index
...
class PygPCQM4Mv2ContactDataset(InMemoryDataset):
    ...
    def __init__(self, root='dataset',
        ...
        self.url = "https://zenodo.org/records/6975830/files/pcqm4m-contact.tsv.gz"#'https://datasets-public-research.s3.us-east-2.amazonaws.com/PCQM4M/pcqm4m-contact.tsv.gz'
