...
from custom_graphgym.loader.dataset.coco_superpixels import COCOSuperpixels
from custom_graphgym.loader.dataset.malnet_tiny import MalNetTiny
from custom_graphgym.loader.dataset.voc_superpixels import VOCSuperpixels
from custom_graphgym.loader.split_generator import (prepare_splits,
                                             set_dataset_splits)
from custom_graphgym.transform.posenc_stats import compute_posenc_stats
from custom_graphgym.transform.transforms import (pre_transform_in_memory,
...
def preformat_OGB_Graph(dataset_dir, name):
    ...
    if name == 'ogbg-ppa':
        ...
        from custom_graphgym.loader.ogbg_code2_utils import idx2vocab, \
...
def preformat_PCQM4Mv2Contact(dataset_dir, name):
    ...
    try:
        # Load locally to avoid RDKit dependency until necessary
        from custom_graphgym.loader.dataset.pcqm4mv2_contact import \
...
def preformat_Peptides(dataset_dir, name):
    ...
    try:
        # Load locally to avoid RDKit dependency until necessary.
        from custom_graphgym.loader.dataset.peptides_functional import \
            PeptidesFunctionalDataset
        from custom_graphgym.loader.dataset.peptides_structural import \
