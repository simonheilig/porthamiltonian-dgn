...
from custom_graphgym.optimizer.extra_optimizers import ExtendedSchedulerConfig

from custom_graphgym.finetuning import load_pretrained_model_cfg, \
    init_model_from_pretrained
from custom_graphgym.logger import create_logger
...
def new_scheduler_config_2(cfg):
...
if __name__ == '__main__':
    ...
    for run_id, seed, split_index in zip(*run_loop_settings()):
        ...
        print(optimizer)
        scheduler = create_scheduler(optimizer, new_scheduler_config_2(cfg))
        print(scheduler)
        # Print model info
        logging.info(model)
        logging.info(cfg)
